	...
	<div align="center" style="padding: 50px;">
		<div align="center" style="padding: 20px">
			<h1>Deposit Form</h1>
				...
				<f:form action="successDeposit" modelAttribute="TransactionsDTO">
						...
						<c:if test="${err!=null}">
							<p style="color: red">${err}</p>
								...
								<tr>
									...
									<td><f:input path="toAccountNumber" required="required" pattern="^[0-9]*$"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td>Description to be deposited</td>
						...
						type="submit" value="Submit" ><span>Deposit</span> </button></a>
						</td>
